Vue.component('progress-box', {
   ...
   computed: {
      ...
      progressTitle() {
         let accmulateText = window.getSystemLang('levelinformation_amount');
         let consumeText = window.getSystemLang('levelinformation_frequency');
         return this.isAmount ? accmulateText : consumeText;
      },
      currentAmount() {
         return this.amount
      },
      ...
      fullText() {
         let key = this.isAmount ? 'levelinformation_amountformat' : 'levelinformation_frequencyformat';
