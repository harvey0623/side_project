Vue.component('point-sidebar', {
   ...
   data: () => ({
      searchStart: window.getSystemLang('mypointdetail_searchstartdatetime'),
      searchEnd: window.getSystemLang('mypointdetail_searchenddatetime'),
   ...
   template: `
      <div id="sidebar" :class="{show: turnon}">
         ...
         <validation-observer tag="ul" class="sidebarFilter" ref="form">
            <li>
               <div class="filterTitle">{{ searchStart }}</div>
               <validation-provider 
                  tag="div" 
                  class="dateOuter" 
                  rules="required"
            ...
            <li>
               <div class="filterTitle">{{ searchEnd }}</div>
               <validation-provider 
                  tag="div" 
                  class="dateOuter" 
                  rules="required"
